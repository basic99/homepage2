...
<button id='reset' type="button" class="btn btn-primary">reset</button>
    ...
    <div class="row g-5 bg-light rounded">
        ...
        <div class="col-md-8">
            ...
            <p>The calculations of acres plotted with QGIS give William Pierce 102 acres, Thomas Pierce 172 acres and Thomas Iken 2000 acres. The acreage given in the grants is 100 acres for William Pierce and 155 acres for Thomas Pierce so a close but not perfect match. The marginal entry for the Iken grant is 1350 acres which is not close the value given by the bounds plotted with QGIS. Howerver, a closer reading of the grant seems to indicate that 1350 is not the correct total but just that part that was part of a grant to Capt. Wm. Pierce in 1643 of 2100 acres. The grant also includes 150 acres granted by the county court and 400 acres for transport of 8 person. Adding these in would give 1900 acres which is close agreement with the area given by QGIS.</p>
